...
namespace Callvote.Commands
{
    public class CustomVotingCommand : ICommand
    {
        ...
        public bool Execute(ArraySegment<string> args, ICommandSender sender, out string response)
        {
            ...
            VotingAPI.CallVoting(new Voting(Callvote.Instance.Translation.AskedCustom.Replace("%Player%", player.Nickname).Replace("%Custom%", argsStrings.First()), nameof(Enums.VotingType.Custom), VotingAPI.Options, player, null));
