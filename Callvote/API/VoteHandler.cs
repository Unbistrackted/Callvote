...
namespace Callvote.API
{
    ...
    public static class VoteHandler
    {
        ...
        public static CallVoteStatus CallVote(Vote vote)
        {
            ...
            {
                return CallVoteStatus.MaxedCallVotes;
            }
            ...
            if (Config.EnableQueue)
            {
                if (IsQueueFull)
                {
                    return CallVoteStatus.QueueIsFull;
                }

                if (IsQueuePaused)
                {
                    return CallVoteStatus.QueueDisabled;
                }
        ...
        /// <summary>
        /// Returns the status message corresponding to the specified <see cref="CallVoteStatus"/>.
        /// </summary>
        ...
        /// recognized.</returns>
        public static string GetMessageFromCallVoteStatus(CallVoteStatus status)
        {
            return status switch
            {
                CallVoteStatus.VoteStarted => Translation.VoteStarted,
                CallVoteStatus.VoteInProgress => Translation.VoteInProgress,
                CallVoteStatus.VoteEnqueued => Translation.VoteEnqueued,
                CallVoteStatus.QueueIsFull => Translation.QueueIsFull,
                CallVoteStatus.QueueDisabled => Translation.QueueDisabled,
                CallVoteStatus.MaxedCallVotes => Translation.MaxVote,
                _ => string.Empty,
            };
        }
