# Description
This is a plugin for [EXILED](https://github.com/Exiled-Team/EXILED) that allows calling Kick, RestartRound, Kill, RespawnWave, or custom votes using console commands in the same format as the Source Engine (Left 4 Dead 2/Counter-Strike: Global Offensive).
