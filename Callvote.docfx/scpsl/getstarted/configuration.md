...
| debug | bool | false | Enables or disables debug logging for Callvote |
...
| message_size | int | 0 | Changes Callvote's message size. (0 = Callvote's default size calculation algorithm) |
...
| enable_s_s_menu | bool | true | Enables or disables the Server Settings Callvote menu integration |
| header_setting_id | int | 887 | Server Settings ID used for the Callvote header |
| yes_keybind_setting_id | int | 888 | Server Settings ID used for the YES vote keybind |
| no_keybind_setting_id | int | 889 | Server Settings ID used for the NO vote keybind |
| mtf_keybind_setting_id | int | 890 | Server Settings ID used for the MTF vote keybind |
| ci_keybind_setting_id | int | 891 | Server Settings ID used for the CI vote keybind |
