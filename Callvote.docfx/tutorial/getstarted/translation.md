...
> [!LINUX]
> ~/.config/SCP Secret Laboratory/LabAPI/configs/``{Server_Port}``/Callvote/translation.yml
...
Alternatively, you can also download each file here: https://github.com/Unbistrackted/Callvote/tree/main/Callvote/Translations
